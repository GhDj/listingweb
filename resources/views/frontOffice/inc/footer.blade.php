                            ...
                            <div class="footer-widget fl-wrap">
                                ...
                                <div class="widget-posts fl-wrap">
                                    <ul>
                                        ...
                                        <li class="clearfix">
                                            <a href="#"  class="widget-posts-img"><img src="{{asset('images/all/2.jpg')}}" class="respimg" alt=""></a>
                                            <div class="widget-posts-descr">
                                        ...
                                        <li class="clearfix">
                                            <a href="#"  class="widget-posts-img"><img src="{{asset('images/all/3.jpg')}}" class="respimg" alt=""></a>
                                            <div class="widget-posts-descr">
