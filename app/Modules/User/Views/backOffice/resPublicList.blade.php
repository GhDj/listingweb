...
@section('content')
    ...
    <div class="breadcrumb">
        <h1>Responsables Complexes Publics</h1> <ul>
            <li><a href="">Tableau de bord</a></li>
            <li><a href="">Utilistauers</a></li>
            <li><a href="">Responsables Complexes Publics</a></li>
        </ul>
    </div>
                    ...
                    <table id="datatable-sportifs"
                        ...
                        @foreach($publicOfficials as $publicOfficial)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('handleDeleteUser',$publicOfficial->id)}}"><span class="badge badge-pill badge-outline-dark p-2 m-1"><i class="i-Remove"></i></span></a>
                                    <a href="#" class="edit_user " get-user-url="{{route('handleGetUserById',$publicOfficial->id)}}"> <span class="badge badge-pill badge-outline-success p-2 m-1"><i class="i-Edit"></i></span></a>
                                </td>
                            </tr>
                            </tr>
                        @endforeach
