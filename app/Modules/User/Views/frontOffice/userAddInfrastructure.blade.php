                                    ...
                                    <div class="custom-form">
                                        <form class=""
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="acceuil" id="acceuil_choice" class="chosen-select">
                                                ...
                                                <div class="col-md-6" style="display:none" id="choices_acceuil">
                                                    <div class="form-group ">
                                                        ...
                                                        <select name="acceuil_choice[]" id="acceuil_multiple_choices" multiple class="chosen-select">
                                            ...
                                            <div class=" fl-wrap filter-tags">
                                                <select name="resto" class="chosen-select">
                                                    <option value="1">Oui</option>
                                            ...
                                            <div class="profile-edit-container add-list-container">
                                                ...
                                                <div class="custom-form">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <select name="handicap_access_choice"  id="handicap_multiple_choices" multiple class="chosen-select ">
